...
const Cards:React.FC<CardProps> = ({card_json}) => {
    return (
        <div className="card sm:w-[48vw] w-full h-auto overflow-hidden">
            <div className="card-content p-4 relative z-10">
                <div className="flex items-center mb-4">
                    <div
                        className="w-12 h-12 rounded-xl shadow-lg mr-3 border-2 border-white/20 bg-blue-500 flex items-center justify-center text-white font-bold text-[0.6rem] leading-tight"
                    >
                        <div className="text-center">{card_json.title}</div>
                    </div>
                ...
                <div className="mb-4">
                    ...
                    <div className="flex flex-wrap -mx-1">
                        {
                            card_json.tech_stack.map((tech, index) => (
                                <div
                                    key={index}
                ...
                <div className="mb-4">
                    <h3 className="text-xs font-semibold text-white/80 mb-2">Features</h3>
                    <ul className="text-xs text-white/60 grid grid-cols-1 gap-1">
                        
                        {
                            card_json.other_features.map((feature, index) => (
                    ...
                    >
                        ...
                        >
                            ...
                            <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round">
                                </g><g id="SVGRepo_iconCarrier"><path d="M11 4H4V18C4 19.1046 4.89543 20 6 20H18C19.1046 20 20 19.1046 20 18V13" stroke="#ffffff" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path><path d="M9 15L20 4" stroke="#ffffff" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path><path d="M15 4H20V9" stroke="#ffffff" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></g></svg>
                        Live Link
                    </button>
                    <button
